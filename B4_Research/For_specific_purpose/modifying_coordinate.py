...
base = wd.World(cam_pos=[-2, 0, 2], lookat_pos=[0, 0, 1]) # モデリング空間を生成
...
def arm_move(rbt_s, onscreen, task):
    ...
    if operation_count == 0:
        ...
        pre_sensor_pos_value = data_array[rgt_hand_num:(rgt_hand_num+3)]
        current_jnt_values = rbt_s.manipulator_dict['arm'].jlc._ikt.num_ik(tgt_pos=pre_tcp_pos + np.dot(modify_rot, rel_tcp_pos),
