...
def update(s, attached_list, rbt_s, onscreen, zero_pos, task):
    ...
    if operation_count % update_cal_frequency == 0:
        # 配列を空にする
        # if len(onscreen) > 0:
        ...
        for i in range(0, 16 * 23, 16):
            ...
            if operation_count == 0:
                ...
                zero_pos[:] = data_array[11*16:(11*16+3)]
            else:
                # 球の位置情報を更新
                ...
                if i == 11 * 16:
                    ...
                    new_tcp_pos = tcp_pos + arm_update_weight * (npvec3 - zero_pos)
