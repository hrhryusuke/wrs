...
rbt_x = rbx.XArmShuidiClient(host="10.2.0.203:18300") # アドレスを確認する
    ...
    for i in range(0, 16 * 23, 16):
        ...
        if operation_count == 0:
            ...
            if i == 11 * 16:
                ...
                rbt_x.arm_move_jspace_path([last_jnt_values, jnt_values], time_interval=.001, start_frame_id=start_frame_id)
                last_jnt_values = jnt_values
            # print(attached_list)
