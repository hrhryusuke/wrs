...
onscreen_rbt = rbt_s.gen_meshmodel()
onscreen_rbt.attach_to(base)
...
def change_mode(task):
    ...
    if mode_independent is True:
        print('independent mode')
    if mode_cooperative is True:
        print('cooperative mode')
    if mode_manipulation is True:
        print('manipulation mode')

    pressed_keys = {'c': keyboard.is_pressed('c'),
                    'v': keyboard.is_pressed('v'),
                    'b': keyboard.is_pressed('b')}

    if pressed_keys["c"] == True:
        ...
        if to_manipulation_toc - to_manipulation_tic >= 1 and mode_manipulation is False:
            ...
            if mode_independent is True or mode_cooperative is True:
                mode_independent = False
                mode_cooperative = False
    elif pressed_keys["v"] == True:
        if change_flag == False:
            change_flag = True
        ...
        if to_independent_toc - to_independent_tic >= 1 and mode_independent is False:
            ...
            mode_independent = True
            if mode_manipulation is True or mode_cooperative is True:
                mode_manipulation = False
                mode_cooperative = False
    elif pressed_keys["b"] == True:
        if change_flag == False:
            change_flag = True
        ...
        if to_cooperative_toc - to_cooperative_tic >= 1 and mode_cooperative is False:
            ...
            if mode_manipulation is True or mode_independent is True:
                mode_manipulation = False
                mode_independent = False
    else:
        change_flag = False
...
def prepare_operate_manipulator(task):
    global operation_count, is_ready_manipulation
